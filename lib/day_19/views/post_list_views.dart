import 'package:abuzar_android/day_19/models/post_models.dart';
import 'package:abuzar_android/day_19/services/api_services.dart';
import 'package:abuzar_android/day_19/services/dio_client.dart';
...
class _PostListScreenDay32State extends State<PostListScreenDay32> {
  ...
  late Future<List<PostListScreenDay32>> _postsFuture;
  ...
  void initState() {
    ...
    _postsFuture = _apiService.getAllPosts() as Future<List<PostListScreenDay32>>;
  }
